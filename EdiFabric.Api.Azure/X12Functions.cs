...
{
    EdiFunctions _ediFunctions = new();
    ...
    {
        return await _ediFunctions.Read(req, executionContext.GetLogger<X12Functions>());
    }
    ...
    {
        return await _ediFunctions.Write(req, executionContext.GetLogger<X12Functions>());
    }
    ...
    {
        return await _ediFunctions.Validate(req, executionContext.GetLogger<X12Functions>());
    }
    ...
    {
        return await _ediFunctions.Ack(req, executionContext.GetLogger<X12Functions>());
    }
}
