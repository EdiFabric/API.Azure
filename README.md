...
The native library is a self-contained shared library. No `EdiFabric.Api` NuGet package, .NET EDI runtime, or JVM is required on the target machine beyond this isolated-process Azure Functions host.
